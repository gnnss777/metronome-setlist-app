    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <span style={{
          ...
          textTransform: 'uppercase', letterSpacing: '0.15em', width: 48, flexShrink: 0,
        }}>
          BPM
        </span>
        <input
        ...
        <span style={{
          ...
          color: 'var(--accent)', whiteSpace: 'nowrap', flexShrink: 0, width: 56, textAlign: 'right',
        }}>
      ...
      <div>
        <span style={{
          display: 'block', fontSize: 13, fontWeight: 500, color: 'var(--text-muted)',
          ...
          {SUBDIVISIONS.map(({ key, label }) => (
            <button
              ...
              style={{
                ...
                boxShadow: config.subdivision === key ? '0 0 20px var(--accent-glow)' : 'none',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
        <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', minHeight: 48 }}>
          ...
          <button
            ...
            style={{
              ...
              position: 'relative', transition: 'background 0.2s var(--smooth)',
            }}
            aria-label={config.accentEveryBar ? 'Desativar acento' : 'Ativar acento'}
          >
            <span style={{
              position: 'absolute', top: 2, left: config.accentEveryBar ? 22 : 2,
        ...
        <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', minHeight: 48 }}>
          ...
          >
            <span style={{
              position: 'absolute', top: 2, left: config.vibrationEnabled ? 22 : 2,
              width: 20, height: 20, borderRadius: '50%', background: 'white',
              transition: 'left 0.2s var(--smooth)',
            }} />
          </button>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
        <button
          ...
          style={{
            height: 48, borderRadius: 'var(--radius-sm)', background: 'var(--bg)',
            fontSize: 13, fontWeight: 500, color: 'var(--text-muted)',
            textTransform: 'uppercase', letterSpacing: '0.1em',
          }}
        >
